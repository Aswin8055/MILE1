...
CREATE TABLE `orders` (
  ...
  PRIMARY KEY (`id`),
  KEY `FK79qfaxx87l1vmampt416v858n` (`food_item_id`),
  KEY `FK32ql8ubntj5uh44ph9659tiih` (`user_id`),
  CONSTRAINT `FK32ql8ubntj5uh44ph9659tiih` FOREIGN KEY (`user_id`) REFERENCES `users` (`id`),
  CONSTRAINT `FK79qfaxx87l1vmampt416v858n` FOREIGN KEY (`food_item_id`) REFERENCES `food_items` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2025-02-21 15:30:06
